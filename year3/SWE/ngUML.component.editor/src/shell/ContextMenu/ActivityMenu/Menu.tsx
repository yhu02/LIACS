...
import Instances from '../ClassMenu/Instances'
import {unEscapeCharacters,escapeCharacters} from '../../../commonFunctions'
    ...
    return (
        <>
            ...
            >
                ...
                <EditableText
                    value={unEscapeCharacters(nodes[node].name)}
                    onChange={(e) => {
                        setNodes({
                            ...nodes,
                            [node]: {
                                ...nodes[node],
                                name: escapeCharacters(e)
                            }
                        });
                    }}
                    maxLength={64}
