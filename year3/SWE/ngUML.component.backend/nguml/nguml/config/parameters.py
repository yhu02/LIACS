...
PARAMS = (
    ...
    # Pagination
    ConfigParam(name='PAGINATE_COUNT', label='Default page size', default=50, field=forms.IntegerField),
    ConfigParam(name='MAX_PAGE_SIZE', label='Maximum page size', default=1000, field=forms.IntegerField),
    # Validation
    ConfigParam(
    ...
    ConfigParam(
        name='NOMINATIM_URL',
        label='Nominatim URL',
        default='https://nominatim.openstreetmap.org/search?q=',
