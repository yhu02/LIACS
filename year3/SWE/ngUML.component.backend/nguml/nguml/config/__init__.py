...
logger = logging.getLogger("nguml.config")


def get_config():
    """
    Return the current ngUML configuration, pulling it from cache if not already loaded in memory.
    """
...
class Config:
    """
    Fetch and store in memory the current nguml configuration. This class must be instantiated prior to access, and
    ...
    def _populate_from_db(self):
        ...
        from nguml.models import ConfigRevision
