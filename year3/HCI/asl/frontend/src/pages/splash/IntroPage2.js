        ...
        <Grid item xs={6}>
          <StyledContent sx={{ textAlign: 'center', alignItems: 'center' }}>
            ...
            <div style={{ marginBottom: '100px' }}>
              <Typography variant="h1" fontFamily='righteous' style={{ margin: '50px' }}> Move the Cursor</Typography>
              <Typography variant="subtitle1" fontSize='26px'> Extend all your fingers, and point with your middlefinger </Typography>
            </div>
