        ...
        <Grid item xs={6}>
          <StyledContent sx={{ textAlign: 'center', alignItems: 'center' }}>
            ...
            <div style={{ marginBottom: '100px' }}>
              <Typography variant="h1" fontFamily='righteous' style={{ margin: '50px' }}> Do a Mouseclick!</Typography>
              <Typography variant="subtitle1" fontSize='26px'> Twitch your index finger as fast as possible </Typography>
            </div>
